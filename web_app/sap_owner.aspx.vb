    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dbread_ais.HasRows Then
            While dbread_ais.Read()
                ...
                If ai_status <> "CF" And ai_status <> "DL" And ai_status <> "NE" And ai_status <> "CP" And ai_status <> "RO" And ai_missing_days > 0 And ai_has_duedate Then
                ...
                If ai_status <> "PD" And ai_status <> "NE" And ai_status <> "DL" And ai_status <> "CP" And ai_status <> "RO" Then 'And ai_missing_days < 1
                    Dim link_btn As New Button
