<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sap_ai_data.aspx.vb" Inherits="sap_ai_data" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>SAP - More information</title>
        ...
        <div class="inner">
           <ul>
            ...
            <table id="ai_list" cellpadding="10" cellspacing="0" style="margin-top: 20px;">
                ...
                <tr>
                    <td id="ai_td_name"><b><asp:Literal ID="ai_tbl_name" runat="server"></asp:Literal></b></td>
                    <td id="ai_td_desc"><b><asp:Literal ID="ai_tbl_desc" runat="server"></asp:Literal></b></td>
                    <td id="ai_td_due"><b><asp:Literal ID="ai_tbl_due" runat="server"></asp:Literal></b></td>
                </tr>
                <tr>
                    <td colspan="3">
                        Detail the information needed to create the action item:<br/>
                        ...
                        <input type="hidden" name="form_ai_name" id="form_ai_name" runat="server"/>
                        <input type="hidden" name="form_ai_descr" id="form_ai_descr" runat="server"/>
                        <input type="hidden" name="form_ai_duedate" id="form_ai_duedate" runat="server"/>
