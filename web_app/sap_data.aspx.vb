...
Partial Class Default2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
            ...
            mail_dict.Add("{reply_mail_link}", "mailto:" & http_req_mail & "?subject=RQ#" & http_req_form_id.Trim() & "%20-%20To%20process%20your%20request%20additional%20info%20is%20needed&body=Dear%20" & userCommon.getNameByMail(http_req_mail) & "%2C%0D%0A%0D%0AHere%20is%20the%20info%20required%3A%0D%0A%0D%0A" & urlBody)
            'next
